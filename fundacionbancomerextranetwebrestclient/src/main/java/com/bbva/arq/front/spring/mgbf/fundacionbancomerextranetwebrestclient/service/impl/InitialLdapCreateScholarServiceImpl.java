 ...
 */
public class InitialLdapCreateScholarServiceImpl implements InitialLdapCreateScholarService {
	private static final Logger log = Logger.getLogger(InitialLdapCreateScholarServiceImpl.class);
