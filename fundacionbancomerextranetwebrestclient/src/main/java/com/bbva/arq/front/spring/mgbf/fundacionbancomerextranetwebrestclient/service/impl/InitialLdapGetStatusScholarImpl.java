 ...
 */
public class InitialLdapGetStatusScholarImpl implements InitialLdapGetStatusScholar {
	private static final Logger log = Logger.getLogger(InitialLdapGetStatusScholarImpl.class);
