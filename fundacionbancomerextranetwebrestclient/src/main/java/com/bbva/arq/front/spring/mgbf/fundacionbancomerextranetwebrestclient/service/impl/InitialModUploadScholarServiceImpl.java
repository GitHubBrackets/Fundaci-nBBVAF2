 ...
 */
public class InitialModUploadScholarServiceImpl implements InitialModUploadScholarService {
	private static final Logger log = Logger.getLogger(InitialModUploadScholarServiceImpl.class);
