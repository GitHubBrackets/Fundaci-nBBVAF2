...
/**
* Function to validate and recover password.
*/
	    				...
	    				showWait("Validando tu informaci\u00f3n, por favor espera",function(){
		    				restExec({
				    			...
				    			finallySuccess: function(){
				    				...
				    				writeLog("scholarValidation.isScholarValid",scholarValidation.isScholarValid);
    ...
    function validatePass () {
         ...
         * @returns {boolean} Variable that indicates when password has/hasn't increasing words.
         */
        ...
        /**
        * Function to be executed when scholar want upload new password.
        */
	    ...
	    $("#noPass").remove();
            ...
            pass2 = $("#password2").val();
            errorPW = false;
            //Validation that passwords aren't be empty.
            if ((pass1 !== "") && (pass2 !== "")) {
                //Diferent passwords
                if (pass1 !== pass2) {
        ...
        /**
         * Function to update scholar's password on LDAP.
         */
        ...
        /**
         * Function to create a scholar on LDAP.
         */
        ...
        /**
         * Function to reactivate scholar on LDAP.
         */
