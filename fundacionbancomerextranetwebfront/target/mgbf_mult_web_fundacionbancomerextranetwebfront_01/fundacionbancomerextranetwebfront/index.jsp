...
<head>
    ...
    //request1.getRequest().getSession().setAttribute("iv-ticketservice", "0odcm5k3+ITLSMIB80s1V3GHThsR0FDJ4EbqNYVJywmh0us1KWN6mRKMBnJirkee");
    request1.getRequest().getSession().setAttribute("iv-user", request.getHeader("iv-user"));
    //request1.getRequest().getSession().setAttribute("iv-user", "ext992441000110001006");
